...
class BankCase(TransactionCase):
    ...
    def test_create_bank(self):
        ...
        bank1 = bank_model.create(
            {
                "name": "Bank1",
                "l10n_it_abi": "l10n_it_abi_1",
                "l10n_it_cab": "l10n_it_cab_1",
            }
        )
        ...
        self.assertEqual(pbank1.l10n_it_bank_abi, "l10n_it_abi_1")
        self.assertEqual(pbank1.l10n_it_bank_cab, "l10n_it_cab_1")
